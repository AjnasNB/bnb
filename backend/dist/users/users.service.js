...
let UsersService = class UsersService {
    ...
    async addPolicy(userId, policyId) {
        return this.userModel
            .findByIdAndUpdate(userId, { $addToSet: { policies: policyId } }, { new: true })
            .exec();
    }
    async addClaim(userId, claimId) {
        return this.userModel
            .findByIdAndUpdate(userId, { $addToSet: { claims: claimId } }, { new: true })
            .exec();
    }
    async updateRiskScore(userId, riskScore) {
        return this.userModel
