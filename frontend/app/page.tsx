...
export default function HomePage() {
  ...
  const isWrongNetwork = chainId && chainId !== 97; // BSC Testnet
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              {/* Network indicator */}
              {isConnected && (
                <div className={`network-indicator ${chainId === 97 ? 'mainnet' : 'testnet'}`}>
                  <div className={`w-2 h-2 rounded-full ${chainId === 97 ? 'bg-green-500' : 'bg-yellow-500'}`}></div>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-yellow-700">
                You're connected to the wrong network. Please switch to BSC Testnet to use ChainSure.
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              ChainSure revolutionizes insurance with blockchain technology, AI processing, and community governance.
            </p>
          </div>
