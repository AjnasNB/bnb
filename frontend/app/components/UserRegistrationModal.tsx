...
export default function UserRegistrationModal({ isOpen, onClose }: UserRegistrationModalProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      onClose();
      alert('Welcome to ChainSure! Your account has been created successfully.');
    } catch (error) {
      ...
      <div className="modal-content">
        ...
        <div className="mb-6">
          <p className="text-gray-600 mb-4">
            Complete your profile to access all ChainSure features including NFT policy creation, 
