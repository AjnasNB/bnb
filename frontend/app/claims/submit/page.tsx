...
export default function SubmitClaimPage() {
  ...
  const loadUserPolicies = async () => {
    try {
      ...
      const response = await fetch(`/api/v1/blockchain/policies/user/${account}/all`);
      if (response.ok) {
  ...
  const executeClaimTransaction = async () => {
    try {
      ...
      // Create claim transaction data with real contract
      const claimTransaction = {
        to: '0x528Bf18723c2021420070e0bB2912F881a93ca53', // Claims Engine contract
        data: '0x', // Placeholder - would be actual claim submission data
        value: '0x0',
        estimatedGas: '300000',
      };
      ...
      alert('Claim transaction executed successfully!');
    } catch (error) {
  ...
  const executeGovernanceTransaction = async () => {
    try {
      ...
      // Create governance transaction data with real contract
      const governanceTransaction = {
        to: '0x364424CBf264F54A0fFE12D99F3902B398fc0B36', // Governance contract
        data: '0x', // Placeholder - would be actual governance proposal data
        value: '0x0',
        estimatedGas: '300000',
      };

      const txHash = await executeTransaction(governanceTransaction);
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="bg-black/20 p-3 rounded-lg">
                      <p className="text-white/60 text-sm mb-1">Contract: 0x528Bf18723c2021420070e0bB2912F881a93ca53</p>
                      <p className="text-white/60 text-sm">Gas: 300,000 (estimated)</p>
                    </div>
                    <button
                  ...
                  <div>
                    ...
                    <div className="bg-black/20 p-3 rounded-lg">
                      <p className="text-white/60 text-sm mb-1">Contract: 0x364424CBf264F54A0fFE12D99F3902B398fc0B36</p>
                      <p className="text-white/60 text-sm">Gas: 300,000 (estimated)</p>
                    </div>
                    <button
